...
public class TransactionMessage extends BasicMessage {
	...
	public TransactionMessage(ServentInfo sender, ServentInfo originalReceiverInfo, ServentInfo receiverInfo,
							  Map<Integer, Integer> senderVectorClock,
							  int amount, BitcakeManager bitcakeManager) {
		super(MessageType.TRANSACTION, sender, originalReceiverInfo, receiverInfo, senderVectorClock, String.valueOf(amount));
