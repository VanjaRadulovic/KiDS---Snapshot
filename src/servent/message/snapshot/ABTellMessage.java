...
public class ABTellMessage extends BasicMessage {
    ...
    public ABTellMessage(ServentInfo sender, ServentInfo receiver, ServentInfo neighbor,
    ...
    protected ABTellMessage(MessageType type, ServentInfo originalSenderInfo, ServentInfo originalReceiverInfo,
    ...
    public Message makeMeASender() {
        ...
        Message toReturn = new ABTellMessage(getMessageType(),
